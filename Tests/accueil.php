      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        ...
        <a class="nav-link" href="http://localhost/tests/adminlog.php">Administration </a>
         ...
         <li class="nav-item">
        <a class="nav-link" href="http://localhost/tests/adminlog.php"></a>
        </li>
...
$req = $bdd->query('SELECT id,auteur, titre, contenu, DATE_FORMAT(date_creation, \'%d\%m\%Y à %Hh%imin%ss\') AS date_creation_fr FROM billets ORDER BY date_creation DESC LIMIT 0,2');
?>
